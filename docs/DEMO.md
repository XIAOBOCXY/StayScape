...
重置后游客首页会同时展示至少 12 个规则生成的杭州产品，覆盖 FAMILY、COUPLE、FRIENDS、SOLO 和 LOCAL_WEEKEND 五类客群，以及 RAIN、SUNNY、CLOUDY 三种天气。可以在“智能组包”的客群快捷入口依次尝试“情侣 / 朋友 / 独自 / 本地周末”，观察主题乐园、旅拍、运动、夜游、美食、演出和城市漫游等资源如何替换非遗主题；这些产品的库存、价格和毛利仍由后端确定性规则计算。
