...
def resource_is_usable(*, merchant_status: str, package_enabled: bool, resource_status: str, capacity: int) -> bool:
    return merchant_status == "ACTIVE" and package_enabled and resource_status == "AVAILABLE" and capacity > 0
