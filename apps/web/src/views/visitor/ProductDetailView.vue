...
const posterVisual = computed(() => poster.value?.image_url || (poster.value?.poster_svg ? posterSvgDataUri(poster.value.poster_svg) : ''))
  ...
  <div v-else-if="product" class="visitor-product-detail">
    ...
    <main class="detail-content">
      ...
      <section v-if="social" class="travel-note-section">
        <div class="travel-note-heading"><span class="section-kicker">旅行者种草口吻 · AI 生成</span><h2>带走这段旅行灵感</h2><button @click="copySocial">复制种草文案</button></div>
...
<style scoped>
.visitor-product-detail{padding-bottom:16px}.detail-loading{min-height:300px;display:grid;place-items:center;color:var(--muted);font-size:14px}.detail-loading span{display:inline-block;width:8px;height:8px;border-radius:50%;background:var(--teal);box-shadow:14px 0 var(--gold),28px 0 var(--teal);margin-right:38px;animation:stay-breathe 1.2s infinite alternate}.product-detail-hero{position:relative;min-height:380px;border-radius:20px;overflow:hidden;background:#173b35;color:#fff}.product-detail-hero>.media-image{position:absolute;inset:0;min-height:100%;border-radius:inherit}.product-detail-hero__veil{position:absolute;inset:0;background:linear-gradient(90deg,rgba(12,39,34,.82),rgba(12,39,34,.2) 75%),linear-gradient(0deg,rgba(12,39,34,.65),transparent 52%)}.back-to-list{position:absolute;z-index:2;top:18px;left:18px;padding:7px 10px;border:1px solid rgba(255,255,255,.42);border-radius:999px;background:rgba(0,0,0,.16);color:#fff;font-size:12px}.product-detail-hero__content{position:absolute;z-index:2;left:6%;right:18%;bottom:42px;max-width:700px}.hero-kicker,.section-kicker{display:inline-flex;align-items:center;gap:8px;color:#23796c;font-size:11px;font-weight:700;letter-spacing:.08em}.hero-kicker{color:rgba(255,255,255,.9)}.hero-kicker i{width:3px;height:3px;border-radius:50%;background:currentColor}.product-detail-hero h1{margin:12px 0 9px;font-size:clamp(30px,4vw,48px);line-height:1.13;letter-spacing:-.8px}.product-detail-hero p{max-width:600px;margin:0;color:rgba(255,255,255,.88);font-size:15px;line-height:1.72}.hero-price{position:absolute;z-index:2;right:6%;bottom:38px;text-align:right}.hero-price strong{display:block;font-size:30px;line-height:1;color:#fff}.hero-price span{display:block;margin-top:6px;color:rgba(255,255,255,.78);font-size:11px}.trip-strip{display:grid;grid-template-columns:repeat(3,1fr);margin:14px 0 0;border:1px solid var(--line);border-radius:14px;overflow:hidden;background:#fff}.trip-strip>div{min-width:0;padding:14px 18px;border-right:1px solid var(--line)}.trip-strip>div:last-child{border-right:0}.trip-strip span{display:block;margin-bottom:5px;color:var(--muted);font-size:11px}.trip-strip strong{display:block;overflow:hidden;color:var(--ink);font-size:14px;text-overflow:ellipsis;white-space:nowrap}.detail-content{max-width:1020px;margin:0 auto;padding:38px 5% 18px}.compact-story,.itinerary-section,.moments-section{margin-bottom:40px}.section-heading{display:flex;align-items:flex-end;justify-content:space-between;gap:16px;margin-bottom:17px}.section-heading h2,.travel-note-heading h2,.share-copy h2,.concierge-header h2{margin:6px 0 0;color:var(--ink);font-family:Georgia,'Songti SC',serif;font-size:27px;font-weight:500;line-height:1.22}.section-count{color:#aac8be;font-family:Georgia,serif;font-size:26px;line-height:1}.story-lead{max-width:760px;margin:0;color:var(--ink);font-size:16px;line-height:1.82}.story-note{max-width:720px;margin:11px 0 0;color:var(--muted);font-size:13px;line-height:1.72}.story-tags{display:flex;flex-wrap:wrap;gap:7px;margin-top:15px}.story-tags span{padding:6px 9px;border-radius:999px;background:#eff7f3;color:#2b7569;font-size:11px}.itinerary-list{display:grid;gap:10px}.itinerary-card{position:relative;display:grid;grid-template-columns:138px minmax(0,1fr) auto;gap:15px;align-items:stretch;min-height:128px;padding:9px;border:1px solid var(--line);border-radius:15px;background:#fff;box-shadow:0 7px 20px rgba(35,64,55,.035)}.itinerary-card__image,.itinerary-card__image .media-image{height:108px;border-radius:10px;overflow:hidden}.itinerary-card__body{min-width:0;padding:3px 0}.itinerary-card__top{display:flex;align-items:center;justify-content:space-between;gap:10px}.itinerary-card__top span{padding:3px 7px;border-radius:999px;background:#edf7f2;color:#287567;font-size:10px;font-weight:700}.itinerary-card__top b{color:#9aafa7;font-size:10px;font-weight:500}.itinerary-card h3{overflow:hidden;margin:7px 0 4px;color:var(--ink);font-size:16px;line-height:1.25;text-overflow:ellipsis;white-space:nowrap}.itinerary-card p{display:-webkit-box;overflow:hidden;margin:0;color:#576963;font-size:12px;line-height:1.56;-webkit-box-orient:vertical;-webkit-line-clamp:2}.itinerary-card small{display:block;overflow:hidden;margin-top:7px;color:#93a19b;font-size:10px;text-overflow:ellipsis;white-space:nowrap}.itinerary-card__quantity{align-self:start;padding:6px 4px 0 0;color:#597a70;font-size:12px}.moments-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:10px}.moments-grid figure{margin:0;overflow:hidden;border:1px solid var(--line);border-radius:14px;background:#fff}.moments-grid .media-image{height:176px}.moments-grid figcaption{padding:9px 10px 10px}.moments-grid figcaption span{display:block;overflow:hidden;color:#7e9690;font-size:10px;text-overflow:ellipsis;white-space:nowrap}.moments-grid figcaption strong{display:block;overflow:hidden;margin-top:4px;color:var(--ink);font-size:13px;text-overflow:ellipsis;white-space:nowrap}.travel-note-section{display:grid;grid-template-columns:190px minmax(0,1fr);gap:30px;margin:0 0 36px;padding:22px 24px;border-radius:16px;background:#f0f7f3}.travel-note-heading h2{font-size:23px}.travel-note-heading button{margin-top:12px;padding:0 0 3px;border:0;border-bottom:1px solid #438b7c;background:transparent;color:#317a6d;font-size:12px;cursor:pointer}.travel-note-copy{padding-top:2px}.travel-note-copy p{margin:0;color:#40544d;font-size:13px;line-height:1.7}.travel-note-copy p.first{margin-bottom:6px;color:var(--ink);font-size:16px;font-weight:650}.travel-note-copy p.hashtag{color:#338070;font-size:11px}.share-section{display:grid;grid-template-columns:124px minmax(0,1fr);gap:22px;align-items:center;margin:0 0 38px;padding:17px 20px;border:1px solid var(--line);border-radius:16px;background:#fff}.poster-preview{padding:6px;border:0;border-radius:9px;background:#163d36;box-shadow:0 8px 18px rgba(24,61,54,.18);cursor:pointer}.poster-preview img{display:block;width:100%;height:auto;border-radius:4px}.share-copy h2{font-size:24px}.share-copy p{max-width:560px;margin:8px 0 0;color:var(--muted);font-size:12px;line-height:1.65}.share-actions{display:flex;gap:8px;margin-top:12px}.concierge-section{padding:22px 24px;border:1px solid #d9ebe3;border-radius:16px;background:linear-gradient(135deg,#f5faf7,#eef7f2)}.concierge-header h2{font-size:25px}.concierge-header p{margin:7px 0 0;color:var(--muted);font-size:12px;line-height:1.65}.concierge-quick{display:flex;gap:7px;flex-wrap:wrap;margin:15px 0}.concierge-quick button,.chat-followups button{padding:7px 9px;border:1px solid #cfe4db;border-radius:999px;background:#fff;color:#3a7166;font-size:11px;cursor:pointer}.concierge-chat{display:grid;gap:8px;max-height:250px;overflow:auto;margin:12px 0}.concierge-bubble{max-width:83%;padding:10px 12px;border-radius:5px 12px 12px;background:#fff;color:#3e534c;font-size:12px;line-height:1.65;box-shadow:0 3px 9px rgba(27,77,63,.05)}.concierge-bubble.is-user{justify-self:end;border-radius:12px 5px 12px 12px;background:#dceee7;color:#1f4e43}.chat-suggestions{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));margin-top:10px}.chat-suggestions .product-card{background:#fff}.chat-followups{display:flex;gap:6px;flex-wrap:wrap;margin-top:8px}.concierge-input{display:flex;gap:8px}.booking-bar{position:relative;z-index:1;display:flex;align-items:center;justify-content:space-between;gap:18px;max-width:1020px;margin:0 auto;padding:14px 5%;border:1px solid #dce8e2;border-radius:15px;background:rgba(255,255,255,.96);box-shadow:0 8px 24px rgba(33,67,57,.12);backdrop-filter:blur(10px)}.booking-bar p{margin:4px 0 0;color:var(--muted);font-size:12px}.booking-bar__right{display:flex;align-items:center;gap:7px;white-space:nowrap}.booking-bar__right strong{color:#1c685a;font-size:22px}.booking-bar__right span{margin-right:6px;color:var(--muted);font-size:11px}.poster-dialog__image{display:block;width:100%;max-height:72vh;object-fit:contain;margin:0 auto;border-radius:6px;background:#edf4f0}.form-tip{margin-top:7px;color:var(--muted);font-size:12px;line-height:1.6}.intent-summary{display:flex;flex-wrap:wrap;gap:8px;margin:8px 0 16px}.intent-summary span{padding:7px 10px;border-radius:999px;background:#edf7f2;color:var(--teal-dark);font-size:12px}.age-row{display:flex;gap:8px;flex-wrap:wrap}.age-row :deep(.el-input-number){width:92px}.safety-callout{margin-top:12px;padding:11px 13px;border-radius:10px;background:#fff8eb;color:#8b6a36;font-size:12px;line-height:1.6}.home-empty{text-align:center;padding:75px 24px;border:1px solid var(--line);background:#fff}.empty-mark{display:grid;place-items:center;width:42px;height:42px;margin:0 auto 14px;border-radius:14px;background:var(--teal);color:#fff;font-family:Georgia,serif;font-size:25px}.home-empty h3{margin:10px 0;color:var(--ink);font-family:Georgia,serif;font-size:24px;font-weight:500}.home-empty p{color:var(--muted);font-size:13px;line-height:1.8}.home-empty .el-button{margin-top:12px}@keyframes stay-breathe{to{transform:translateX(7px);opacity:.5}}@media(max-width:800px){.visitor-product-detail{padding-bottom:8px}.product-detail-hero{min-height:324px;border-radius:15px}.back-to-list{top:12px;left:12px;font-size:11px}.product-detail-hero__content{right:15px;bottom:21px;left:18px}.product-detail-hero h1{margin:9px 0 7px;font-size:29px;letter-spacing:-.5px}.product-detail-hero p{font-size:13px;line-height:1.58}.hero-price{right:16px;bottom:20px}.hero-price strong{font-size:23px}.trip-strip{margin-top:10px;border-radius:11px}.trip-strip>div{padding:10px 9px}.trip-strip span{font-size:10px}.trip-strip strong{font-size:11px}.detail-content{padding:27px 0 12px}.compact-story,.itinerary-section,.moments-section{margin-bottom:29px}.section-heading{margin-bottom:13px}.section-heading h2,.travel-note-heading h2,.share-copy h2,.concierge-header h2{font-size:22px}.section-count{font-size:21px}.story-lead{font-size:14px;line-height:1.74}.story-note{font-size:12px;line-height:1.62}.story-tags{margin-top:12px}.itinerary-list{gap:8px}.itinerary-card{grid-template-columns:98px minmax(0,1fr) 20px;gap:9px;min-height:102px;padding:6px;border-radius:12px}.itinerary-card__image,.itinerary-card__image .media-image{height:90px;border-radius:8px}.itinerary-card__body{padding:2px 0}.itinerary-card__top span{padding:2px 6px;font-size:9px}.itinerary-card h3{margin:5px 0 3px;font-size:14px}.itinerary-card p{font-size:11px;line-height:1.45}.itinerary-card small{margin-top:5px;font-size:9px}.itinerary-card__quantity{padding-top:5px;font-size:11px}.moments-grid{grid-template-columns:repeat(3,minmax(0,1fr));gap:6px}.moments-grid .media-image{height:122px}.moments-grid figure{border-radius:10px}.moments-grid figcaption{padding:7px}.moments-grid figcaption span{font-size:8px}.moments-grid figcaption strong{margin-top:3px;font-size:10px}.travel-note-section{grid-template-columns:1fr;gap:12px;margin-bottom:28px;padding:17px 16px;border-radius:13px}.travel-note-heading h2{font-size:20px}.travel-note-heading button{margin-top:8px}.travel-note-copy p{font-size:12px;line-height:1.6}.travel-note-copy p.first{font-size:14px}.share-section{grid-template-columns:88px minmax(0,1fr);gap:14px;margin-bottom:28px;padding:12px;border-radius:13px}.share-copy h2{font-size:20px}.share-copy p{font-size:11px;line-height:1.55}.share-actions{gap:6px;margin-top:9px}.share-actions :deep(.el-button){padding:7px 9px;font-size:11px}.concierge-section{padding:17px 14px;border-radius:13px}.concierge-header h2{font-size:21px}.concierge-quick{margin:12px 0}.concierge-quick button{padding:6px 8px;font-size:10px}.concierge-input :deep(.el-input__wrapper){min-height:31px}.concierge-input :deep(.el-button){padding:8px 11px}.booking-bar{gap:10px;padding:11px 12px;border-radius:12px}.booking-bar p{display:none}.booking-bar__right{gap:5px}.booking-bar__right strong{font-size:18px}.booking-bar__right span{display:none}.booking-bar__right :deep(.el-button){padding:8px 10px;font-size:12px}.poster-dialog__image{max-height:67vh}}@media(max-width:390px){.product-detail-hero h1{font-size:26px}.moments-grid .media-image{height:108px}.itinerary-card{grid-template-columns:88px minmax(0,1fr) 18px}.itinerary-card__image,.itinerary-card__image .media-image{height:84px}.booking-bar__right strong{font-size:16px}}
